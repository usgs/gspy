...
.. "examples/Data_conversion/plot_csv_to_netcdf.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_Data_conversion_plot_csv_to_netcdf.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_Data_conversion_plot_csv_to_netcdf.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    DEP_BOT passed dimensions do not align with data, skipping
    THK passed dimensions do not align with data, skipping
