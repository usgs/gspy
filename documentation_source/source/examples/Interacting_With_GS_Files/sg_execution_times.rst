...
Computation times
=================
**00:02.110** total execution time for 3 files **from examples/Interacting_With_GS_Files**:
...
.. container::
   ...
   * - Example
     - Time
     - Mem (MB)
   * - :ref:`sphx_glr_examples_Interacting_With_GS_Files_plot_cross_section.py` (``plot_cross_section.py``)
     - 00:02.110
     - 0.0
